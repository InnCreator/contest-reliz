...
class Screen3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView: View = inflater.inflate(R.layout.fragment_screen3, container, false)
        ...
        rootView.findViewById<MaterialButton>(R.id.btn1).setOnClickListener {
            findNavController().navigate(Screen3FragmentDirections.actionScreen3FragmentToScreen1Fragment())
        }
        rootView.findViewById<MaterialButton>(R.id.screen1).setOnClickListener {
            findNavController().navigate(Screen3FragmentDirections.actionScreen3FragmentToScreen2Fragment())
        }
